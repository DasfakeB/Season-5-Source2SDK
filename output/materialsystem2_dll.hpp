...
namespace cs2_dumper::schemas::materialsystem2_dll {
    ...
    // ── Enums ────────────────────────────────────
    enum class BloomBlendMode_t : int32_t {
        BLOOM_BLEND_ADD = 0,
        BLOOM_BLEND_SCREEN = 1,
        BLOOM_BLEND_BLUR = 2,
    };

    enum class HorizJustification_e : int32_t {
    ...
    enum class ViewFadeMode_t : int32_t {
