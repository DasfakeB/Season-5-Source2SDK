...
namespace cs2_dumper::schemas::client_dll {
    ...
    // CCSGO_EndOfMatchLineupEnd : C_CSGO_EndOfMatchLineupEndpoint
    ...
    // CCS_PortraitWorldCallbackHandler : C_BaseEntity
    namespace CCS_PortraitWorldCallbackHandler {
    }

    // CCashStack : C_BaseModelEntity
    ...
    // CChoreoInfoTarget : C_PointEntity
    namespace CChoreoInfoTarget {
    }

    // CCitadelSoundOpvarSetOBB : C_BaseEntity
    ...
    // CFuncRetakeBarrier : C_DynamicProp
    ...
    // CPointChildModifier : C_PointEntity
    ...
    // CPulseGameBlackboard : C_BaseEntity
    ...
    // CSoundOpvarSetBoxEntity : C_SoundOpvarSetPointEntity
    namespace CSoundOpvarSetBoxEntity {
    }

    // CSpriteOriented : C_Sprite
    ...
    // C_BaseTrigger : C_BaseModelEntity
    ...
    // C_CS2HudModelAddon : C_LateUpdatedAnimating
    namespace C_CS2HudModelAddon {
    }

    // C_CS2HudModelArms : C_CS2HudModelBase
    namespace C_CS2HudModelArms {
    }

    // C_CS2HudModelBase : C_LateUpdatedAnimating
    namespace C_CS2HudModelBase {
    }

    // C_CS2HudModelWeapon : C_CS2HudModelBase
    namespace C_CS2HudModelWeapon {
    }

    // C_CS2WeaponModuleBase : CBaseAnimGraph
    ...
    // C_CSGO_PreviewModel : CBaseAnimGraph
    ...
    // C_CSWeaponBaseShotgun : C_CSWeaponBase
    ...
    // C_EnvCombinedLightProbeVolumeAlias_func_combined_light_probe_volume : C_EnvCombinedLightProbeVolume
    ...
    // C_EnvWindController : C_BaseEntity
    ...
    // C_FuncMoveLinear : C_BaseModelEntity
    namespace C_FuncMoveLinear {
    }

    // C_FuncMover : C_BaseModelEntity
    ...
    // C_KeychainModule : C_CS2WeaponModuleBase
    ...
    // C_LateUpdatedAnimating : CBaseAnimGraph
    namespace C_LateUpdatedAnimating {
    }

    // C_LightDirectionalEntity : C_BaseModelEntity
    ...
    // C_LightOrthoEntity : C_BaseModelEntity
    namespace C_LightOrthoEntity {
    }

    // C_LightSpotEntity : C_BaseModelEntity
    ...
    // C_PhysicsPropMultiplayer : C_BreakableProp
    ...
    // C_PlayerSprayDecal : C_BaseModelEntity
    ...
    // C_PointWorldText : C_BaseModelEntity
    ...
    // C_PortraitWorldCallbackHandler : C_BaseEntity
    ...
    // C_SoundEventEntity : C_BaseEntity
    ...
    // C_SoundEventEntityAlias_snd_event_point : C_SoundEventEntity
    namespace C_SoundEventEntityAlias_snd_event_point {
    }

    // C_SoundEventOBBEntity : C_SoundEventEntity
    namespace C_SoundEventOBBEntity {
        constexpr std::ptrdiff_t m_vMins = 0x6C0; // Vector
        constexpr std::ptrdiff_t m_vMaxs = 0x6CC; // Vector
    }

    // C_SoundEventPathCornerEntity : C_SoundEventEntity
    ...
    // C_SoundEventSphereEntity : C_SoundEventEntity
    ...
    // C_StattrakModule : C_CS2WeaponModuleBase
    ...
    // C_WeaponNOVA : C_CSWeaponBaseShotgun
    ...
    // C_WeaponSawedoff : C_CSWeaponBaseShotgun
    ...
    // C_WeaponXM1014 : C_CSWeaponBaseShotgun
    ...
    enum class ___wF_ : int32_t {
    };

    enum class ___wF_ : int32_t {
    };

    enum class _5_wF_ : int32_t {
    };

    enum class _62_F_ : int32_t {
    };

    enum class _6_wF_ : int32_t {
    };

    enum class ___wF_ : int32_t {
    };

    enum class _D_wF_ : int32_t {
    };
    ...
    enum class C_BaseCombatCharacter__WaterWakeMode_t : int32_t {
        WATER_WAKE_NONE = 0,
        WATER_WAKE_IDLE = 1,
    ...
    enum class _0_wF_ : int32_t {
    };

    enum class _7_wF_ : int32_t {
    };

    enum class _J_wF_ : int32_t {
    };

    enum class ___wF_ : int32_t {
    };

    enum class _ : int32_t {
    };
    ...
    enum class _72_F_ : int32_t {
    };

    enum class ___wF_ : int32_t {
    };

    enum class _E_wF_ : int32_t {
    };

    enum class _F_wF_ : int32_t {
    };

    enum class _R_wF_ : int32_t {
    };

    enum class _T_wF_ : int32_t {
    };
