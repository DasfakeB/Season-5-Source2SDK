...
namespace cs2_dumper::schemas::rendersystemdx11_dll {
    ...
    enum class RenderBufferFlags_t : int32_t {
    ...
    enum class RenderPrimitiveType_t : int32_t {
    ...
    enum class UpscalerType_t : int32_t {
        UPSCALER_NONE = 0,
        UPSCALER_AMD_FSR2 = 1,
        UPSCALER_AMD_FSR3 = 2,
