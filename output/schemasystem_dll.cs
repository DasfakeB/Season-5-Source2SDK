...
public enum __h___ : int {
}

public enum _SUVWATAUAVAW__ : int {
}

public enum H____c___H__u__H_H__h__ : int {
}

public enum H__Yc_ : int {
}

public enum H__q3_ : int {
}
...
public enum _8____ : int {
}

public enum ___p_ : int {
}
